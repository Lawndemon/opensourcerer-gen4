...
FORM_TEMPLATES: list[FormTemplate] = [
    # --- Fire Officer (field) ---
    FormTemplate("fire-officer", "ICS-201", "Incident Briefing", "ics_201"),
    FormTemplate("fire-officer", "ICS-214", "Activity Log", "placeholder"),
    FormTemplate("fire-officer", "ICS-213", "General Message", "placeholder"),
    # --- Incident Commander (ICS Command) ---
    FormTemplate("incident-commander", "ICS-202", "Incident Objectives", "placeholder"),
    FormTemplate("incident-commander", "ICS-207", "Incident Organization Chart", "placeholder"),
    FormTemplate("incident-commander", "ICS-209", "Incident Status Summary", "placeholder"),
    # --- Safety Officer (ICS Command Staff) ---
    FormTemplate("safety-officer", "ICS-208", "Site Safety and Health Plan", "placeholder"),
    FormTemplate("safety-officer", "ICS-215A", "IAP Safety Analysis", "placeholder"),
    FormTemplate("safety-officer", "ICS-214", "Activity Log", "placeholder"),
    ...
    FormTemplate("liaison-officer", "ICS-214", "Activity Log", "placeholder"),
    ...
    FormTemplate("information-officer", "ICS-214", "Activity Log", "placeholder"),
    # --- Section Chief — Operations ---
    FormTemplate("section-chief-operations", "ICS-204", "Assignment List", "placeholder"),
    FormTemplate(
        "section-chief-operations", "ICS-215", "Operational Planning Worksheet", "placeholder"
    ),
    FormTemplate("section-chief-operations", "ICS-210", "Resource Status Change", "placeholder"),
    # --- Section Chief — Planning ---
    FormTemplate("section-chief-planning", "ICS-203", "Organization Assignment List", "placeholder"),
    FormTemplate("section-chief-planning", "ICS-211", "Incident Check-In List", "placeholder"),
    FormTemplate("section-chief-planning", "ICS-209", "Incident Status Summary", "placeholder"),
    # --- Section Chief — Logistics ---
    FormTemplate(
        "section-chief-logistics", "ICS-205", "Incident Radio Communications Plan", "placeholder"
    ),
