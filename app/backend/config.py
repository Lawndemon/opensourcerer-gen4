...
CONFIG_REFINE_CONDITION_APPROACH = "refine_condition_approach"
CONFIG_RECOMMEND_ACTIONS_APPROACH = "recommend_actions_approach"
CONFIG_EXTRACT_FORMS_APPROACH = "extract_forms_approach"
